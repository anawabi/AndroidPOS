...
import com.xamuor.cashco.Adapters.ListProductAdapter;
import com.xamuor.cashco.Model.ListProductDataModal;
...
//    Load all products for a specific category from server
    private void loadProducts(final int ctgId) {
        StringRequest request = new StringRequest(Request.Method.POST, Routes.setUrl("listProduct"), new Response.Listener<String>() {
            @Override
